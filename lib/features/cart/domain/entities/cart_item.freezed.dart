...
mixin _$CartItem {
 ...
 String get id; Product get product; int get quantity;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartItem&&(identical(other.id, id) || other.id == id)&&(identical(other.product, product) || other.product == product)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
...
@useResult
$Res call({
 String id, Product product, int quantity
});
...
class _CartItem extends CartItem {
  const _CartItem({required this.id, required this.product, required this.quantity}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CartItem&&(identical(other.id, id) || other.id == id)&&(identical(other.product, product) || other.product == product)&&(identical(other.quantity, quantity) || other.quantity == quantity));
}
